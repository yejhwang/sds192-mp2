...
joined_three <- joined_three %>%
  ...
  org_type == "C" ~ "Corporation",
  org_type == "L" ~ "Labor organization",
  org_type == "M" ~ "Membership organization",
  org_type == "T" ~ "Trade association",
  org_type == "V" ~ "Cooperative",
  org_type == "W" ~ "Corporation without capital stock",
  TRUE ~ org_type))
```
